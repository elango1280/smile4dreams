...
<title>Smile for Dreams - Events</title>
<meta name="description" content="Goal of smile4dreams (an non-profit organization) is to create the awareness among Indians about volunteering services.">
<meta name="keywords" content="events, volunteer, india, volunteer india, non profit organization, smile4dreams, smile for dreams, schools">
...
#orgcontent h2 a {
    color: #89B512;
    font-family: Clarendon,Clarendon,Georgia,serif;
    font-size: 15px !important;
    margin-bottom: 8px;
    text-decoration: none;
    padding-left: 25px;
}
.org_detail_org_name a {
    float: left;
    font-size: 15px !important;
}
.description {
...
.org_details h2, .org_details h3 {
    color: #3497B4 !important;
...
.org_details> ul > li:last-child, .org_details> ul > li.last, .flow .org_details> ul > li {
    border-bottom: medium none;
}
.adr, .adr li ul, .org_details p, .org_details li ul {
    float: left;
    font-size: 12px;
    margin: 0;
    width: 200px;
...
<header> <!-- Defining the header section of the page with the appropriate tag -->
	...
	<nav class="clear">
		<ul>
			...
			<li class="dedi"><a class="" style="background-color: #333333;color: #FFFFFF;text-decoration: none;" href="/events.php">Events</a></li>			
...
<section> 
  ...
  <div class="main_content">   
   ...
   <div style="padding-bottom:10px" ='disclaimer'=""><b style="color: #3497B4 !important;">Note: </b>To register/add an Event, use our <a href="http://smile4dreams.org/contactus.php">Contact Us Form</a> to send the details.<br><br></div>
  </div>
...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
     ...
     <div class="nonprofit">
     	...
     	<div class="desc">Have your own service project (Non-profit organization)? Learn how you can invite others to join. 
     	<div style="padding-left:30px;padding-top:10px"><a class="custom_button" href="/resources/nonprofitreg.php">Submit</a></div></div>
     </div>
     <div class="bottom-cut"></div>  
     <div class="nonprofit">

...
<title>Smile for Dreams - Contact Us</title>
<meta name="description" content="Contact Us Page">
<meta name="keywords" content="contact, contact us, smile4dreams, smile for dreams">
...
<header> <!-- Defining the header section of the page with the appropriate tag -->
	...
	<nav class="clear">
		<ul>			
			...
			<li class="order"><a class="" style="background-color: #333333;color: #FFFFFF;text-decoration: none;" href="#">Contact Us</a></li>			
		</ul>
	</nav>  
</header>
<section>   
  <article class="clear" style="padding:12px; background-color: white"> 
  ...
  <div class="main_content">
	...
	<table class="submit">
		<tr width="100%"> 
			<td width="70%">
				...
				<span id="error_message" class="success" style='color:red'></span>
			</td>
			<td width="30%" style="padding-right:25px;">	 								
    ...
    <div id="maininfo" style="padding: 15px 30px;"><h4 style="font-size: 1.2em;font-weight: bold;margin-bottom: 10px;padding-bottom: 0;padding-left: 5px;">Main Office:</h4>
    <p style="font-size: 1.0em;padding-bottom: 10px;">Phone: (+1) (972) 589 5169<br>Fax: NA </p>
    <p style="font-size: 1.0em;padding-bottom: 10px;">
    	<strong>Mailing Address:</strong><br>Smile for Dreams<br>
	    1221 NE 51st Ave, Apt#301<br>
	    Hillsboro,OR 97124
    </p><div id="maininfobottom"></div></div>
<div class="envelope">
	<img id="envelope" src="/img/envelope.png" alt="envelope" width="246" height="175" style="display:none;"/>
</div>
<!-- The JavaScript --> 
  	...
  	<div class="footer_links" style="width:887px;">
  	   ...
  	   <div class="col2">
              <ul style="list-style: none outside none;font-size: 0.8em;padding-bottom:0px;padding-left:0px;border: 0 none;margin: 0;outline: 0 none;vertical-align: baseline;">
                 ...
                 <li style="padding-bottom:10px"><a href="#">Donate to Smile for Dreams</a></li>                 
              </ul>
           </div>          
  	   <div class="col3">
              <ul style="list-style: none outside none;font-size: 0.8em;padding-bottom:0px;padding-left:0px;border: 0 none;margin: 0;outline: 0 none;vertical-align: baseline;">
